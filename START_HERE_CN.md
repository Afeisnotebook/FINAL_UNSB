...
截至`2026-08-31 00:48 +08:00`，AM-TNC与MCRB均已完成第二个晚期点e175，并继续最后
25个data epochs。MCRB的真实e100描述性delta为`+2.158 dB`，但已验证它不会触发早停、4090复赛、排名或冻结，科学硬门
...
MCRB e175又变为`-0.082 dB`、4/6域正，最差域`-1.777 dB`；e150→e175候选自身只提升
`0.261 dB`，plain却提升`1.238 dB`。这说明e150优势没有平滑保持，最终资格只能由
完整e150/e175/e200轨迹和e200终点决定。
AM-TNC e175为`-0.604 dB`、仅1/6域正，最差域`-1.212 dB`，SSIM和LPIPS均退化；
e150→e175候选自身回撤`0.249 dB`，plain提升`0.892 dB`。这次既有候选绝对退化，
也有plain追赶，是比e125更强的当前实现长期风险证据，但仍不替代e200终点。
