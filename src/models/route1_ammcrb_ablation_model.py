"""Model registry entry for AM-MCRB mechanism ablations."""

from __future__ import annotations

from models.route1.ammcrb_ablation import AMMCRBAblationMixin
from models.sb_model import SBModel


class Route1AmmcrbAblationModel(AMMCRBAblationMixin, SBModel):
    @staticmethod
