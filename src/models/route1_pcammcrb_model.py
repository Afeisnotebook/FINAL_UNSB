"""Model registry for the conditional-sampling/AM-MCRB synthesis."""
...
class Route1PcammcrbModel(PCAMMCRBMixin, SBModel):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        parser = SBModel.modify_commandline_options(parser, is_train)
        parser.add_argument("--pcammcrb_enable", type=_str2bool, default=True)
        parser.add_argument(
            "--pcammcrb_sampling_parent", choices=SAMPLING_PARENTS, default="pcnr",
        )
