"""Model registry for conditional sampling plus residual-feasible RF-MCRB."""
...
class Route1PcrfmcrbModel(PCRFMCRBMixin, SBModel):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        parser = SBModel.modify_commandline_options(parser, is_train)
        parser.add_argument("--pcrfmcrb_enable", type=_str2bool, default=True)
        parser.add_argument(
            "--pcrfmcrb_sampling_parent",
