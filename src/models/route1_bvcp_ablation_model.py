"""Model entry for source-bound BVCP mechanism ablations."""

from __future__ import annotations

from models.route1.bvcp_ablation import BVCPAblationMixin
from models.sb_model import SBModel


class Route1BvcpAblationModel(BVCPAblationMixin, SBModel):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument(
            "--bvcp_ablation_role", choices=["proposal_only", "observable_only"],
