"""Model registry for Residual-Feasible Adam-Metric MCRB."""
...
class Route1RfammcrbModel(RFAMMCRBMixin, SBModel):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        parser = SBModel.modify_commandline_options(parser, is_train)
        parser.add_argument("--rfammcrb_enable", type=_str2bool, default=True)
