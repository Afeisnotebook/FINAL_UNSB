"""Model registry entry for MCRB mechanism ablations."""

from __future__ import annotations

from models.route1.mcrb_ablation import MCRBAblationMixin
from models.sb_model import SBModel


class Route1McrbAblationModel(MCRBAblationMixin, SBModel):
    @staticmethod
