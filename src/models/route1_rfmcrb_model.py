"""Model registry for Residual-Feasible Euclidean MCRB."""
...
class Route1RfmcrbModel(RFMCRBMixin, SBModel):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        parser = SBModel.modify_commandline_options(parser, is_train)
        parser.add_argument("--rfmcrb_enable", type=_str2bool, default=True)
