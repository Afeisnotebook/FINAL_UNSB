...
# A public terminal h=1 row also measures agreement with the next independent
# native update.  That diagnostic needs an internal two-update native branch,
# but h=2 is not itself a public row or queue horizon.
